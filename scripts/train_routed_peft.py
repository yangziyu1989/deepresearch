#!/usr/bin/env python3
"""Routed PEFT trainer for Tao task plans."""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run one routed PEFT experiment task")
    ...
    run_training_task(task, args.workspace, routed=True)
